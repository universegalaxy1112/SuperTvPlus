...
public class VideoListSectionBindingImpl extends VideoListSectionBinding  {
    ...
    private VideoListSectionBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 0
            ...
            , (com.uni.julio.superplus.helper.TVRecyclerView) bindings[7]
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.categoryAdapter == variableId) {
            setCategoryAdapter((com.uni.julio.superplus.adapter.MoviesCategoryAdapter) variable);
        }
        else if (BR.movieCategory == variableId) {
            setMovieCategory((com.uni.julio.superplus.model.MovieCategory) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setCategoryAdapter(@Nullable com.uni.julio.superplus.adapter.MoviesCategoryAdapter CategoryAdapter) {
    ...
    public void setMovieCategory(@Nullable com.uni.julio.superplus.model.MovieCategory MovieCategory) {
    ...
    protected void executeBindings() {
        ...
        com.uni.julio.superplus.adapter.MoviesCategoryAdapter categoryAdapter = mCategoryAdapter;
        com.uni.julio.superplus.model.MovieCategory movieCategory = mMovieCategory;
    ...
    public static class OnClickListenerImpl implements android.view.View.OnClickListener{
        private com.uni.julio.superplus.adapter.MoviesCategoryAdapter value;
        public OnClickListenerImpl setValue(com.uni.julio.superplus.adapter.MoviesCategoryAdapter value) {
            this.value = value;
