...
public class LivetvnewListBindingImpl extends LivetvnewListBinding  {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.livetvAdapter == variableId) {
            setLivetvAdapter((com.uni.julio.superplus.adapter.LivetvAdapterNew) variable);
        }
        else if (BR.liveProgramItem == variableId) {
            setLiveProgramItem((com.uni.julio.superplus.model.LiveProgram) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setLivetvAdapter(@Nullable com.uni.julio.superplus.adapter.LivetvAdapterNew LivetvAdapter) {
    ...
    public void setLiveProgramItem(@Nullable com.uni.julio.superplus.model.LiveProgram LiveProgramItem) {
    ...
    protected void executeBindings() {
        ...
        com.uni.julio.superplus.adapter.LivetvAdapterNew livetvAdapter = mLivetvAdapter;
        com.uni.julio.superplus.model.LiveProgram liveProgramItem = mLiveProgramItem;
    ...
    public static class OnClickListenerImpl implements android.view.View.OnClickListener{
        private com.uni.julio.superplus.adapter.LivetvAdapterNew value;
        public OnClickListenerImpl setValue(com.uni.julio.superplus.adapter.LivetvAdapterNew value) {
            this.value = value;
