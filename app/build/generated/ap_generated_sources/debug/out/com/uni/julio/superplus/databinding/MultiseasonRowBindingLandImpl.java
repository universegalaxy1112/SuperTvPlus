...
public class MultiseasonRowBindingLandImpl extends MultiseasonRowBinding  {
    ...
    public MultiseasonRowBindingLandImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 5, sIncludes, sViewsWithIds));
    }
    private MultiseasonRowBindingLandImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.moviesAdapter == variableId) {
            setMoviesAdapter((com.uni.julio.superplus.adapter.MultiSeasonAdapter) variable);
        }
        else if (BR.moviesMenuItem == variableId) {
            setMoviesMenuItem((com.uni.julio.superplus.model.Episode) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setMoviesAdapter(@Nullable com.uni.julio.superplus.adapter.MultiSeasonAdapter MoviesAdapter) {
    ...
    public void setMoviesMenuItem(@Nullable com.uni.julio.superplus.model.Episode MoviesMenuItem) {
    ...
    protected void executeBindings() {
        ...
        com.uni.julio.superplus.adapter.MultiSeasonAdapter moviesAdapter = mMoviesAdapter;
        com.uni.julio.superplus.model.Episode moviesMenuItem = mMoviesMenuItem;
        ...
        if ((dirtyFlags & 0x6L) != 0) {
            ...
            com.uni.julio.superplus.binding.BindingAdapters.setTitleEpisode(this.detail, moviesMenuItemPosition);
    ...
    public static class OnClickListenerImpl implements android.view.View.OnClickListener{
        private com.uni.julio.superplus.adapter.MultiSeasonAdapter value;
        public OnClickListenerImpl setValue(com.uni.julio.superplus.adapter.MultiSeasonAdapter value) {
            this.value = value;
