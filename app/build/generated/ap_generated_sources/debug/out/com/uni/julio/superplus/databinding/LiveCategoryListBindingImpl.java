...
public class LiveCategoryListBindingImpl extends LiveCategoryListBinding  {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.liveCategoryAdapter == variableId) {
            setLiveCategoryAdapter((com.uni.julio.superplus.adapter.LiveCategoryAdapter) variable);
        }
        else if (BR.liveCategory == variableId) {
            setLiveCategory((com.uni.julio.superplus.model.LiveTVCategory) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setLiveCategoryAdapter(@Nullable com.uni.julio.superplus.adapter.LiveCategoryAdapter LiveCategoryAdapter) {
    ...
    public void setLiveCategory(@Nullable com.uni.julio.superplus.model.LiveTVCategory LiveCategory) {
    ...
    protected void executeBindings() {
        ...
        com.uni.julio.superplus.adapter.LiveCategoryAdapter liveCategoryAdapter = mLiveCategoryAdapter;
        ...
        com.uni.julio.superplus.model.LiveTVCategory liveCategory = mLiveCategory;
    ...
    public static class OnClickListenerImpl implements android.view.View.OnClickListener{
        private com.uni.julio.superplus.adapter.LiveCategoryAdapter value;
        public OnClickListenerImpl setValue(com.uni.julio.superplus.adapter.LiveCategoryAdapter value) {
            this.value = value;
