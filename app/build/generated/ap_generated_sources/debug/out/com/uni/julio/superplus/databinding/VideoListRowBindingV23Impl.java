...
public class VideoListRowBindingV23Impl extends VideoListRowBinding  {
    ...
    public VideoListRowBindingV23Impl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 3, sIncludes, sViewsWithIds));
    }
    private VideoListRowBindingV23Impl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.moviesAdapter == variableId) {
            setMoviesAdapter((com.uni.julio.superplus.adapter.MoviesRecyclerAdapter) variable);
        }
    ...
    public void setMoviesAdapter(@Nullable com.uni.julio.superplus.adapter.MoviesRecyclerAdapter MoviesAdapter) {
    ...
    protected void executeBindings() {
        ...
        com.uni.julio.superplus.adapter.MoviesRecyclerAdapter moviesAdapter = mMoviesAdapter;
        ...
        if ((dirtyFlags & 0x6L) != 0) {
            ...
            com.uni.julio.superplus.binding.BindingAdapters.loadImage(this.img, moviesMenuItemHDPosterUrl);
            androidx.databinding.adapters.TextViewBindingAdapter.setText(this.title, moviesMenuItemGetTitle);
        }
    }
    // Listener Stub Implementations
    public static class OnClickListenerImpl implements android.view.View.OnClickListener{
        private com.uni.julio.superplus.adapter.MoviesRecyclerAdapter value;
        public OnClickListenerImpl setValue(com.uni.julio.superplus.adapter.MoviesRecyclerAdapter value) {
            this.value = value;
