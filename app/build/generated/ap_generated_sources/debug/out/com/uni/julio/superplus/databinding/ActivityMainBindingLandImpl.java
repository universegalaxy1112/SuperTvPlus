...
public class ActivityMainBindingLandImpl extends ActivityMainBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.maincategory, 4);
    }
    // views
    // variables
    // values
    ...
    private ActivityMainBindingLandImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 0
            ...
            , (com.uni.julio.superplus.helper.TVRecyclerView) bindings[4]
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.activityMainBindingVM == variableId) {
            setActivityMainBindingVM((com.uni.julio.superplus.viewmodel.MainCategoriesMenuViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setActivityMainBindingVM(@Nullable com.uni.julio.superplus.viewmodel.MainCategoriesMenuViewModel ActivityMainBindingVM) {
