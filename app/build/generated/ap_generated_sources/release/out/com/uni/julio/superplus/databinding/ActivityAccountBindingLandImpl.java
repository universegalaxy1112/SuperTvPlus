...
public class ActivityAccountBindingLandImpl extends ActivityAccountBinding  {
    ...
    public ActivityAccountBindingLandImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 15, sIncludes, sViewsWithIds));
    }
    private ActivityAccountBindingLandImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.accountDetailsVM == variableId) {
            setAccountDetailsVM((com.uni.julio.superplus.viewmodel.AccountDetailsViewModel) variable);
        }
        else if (BR.user == variableId) {
            setUser((com.uni.julio.superplus.model.User) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setAccountDetailsVM(@Nullable com.uni.julio.superplus.viewmodel.AccountDetailsViewModel AccountDetailsVM) {
    ...
    public void setUser(@Nullable com.uni.julio.superplus.model.User User) {
        this.mUser = User;
        synchronized(this) {
            mDirtyFlags |= 0x4L;
        }
    ...
    protected void executeBindings() {
        ...
        com.uni.julio.superplus.viewmodel.AccountDetailsViewModel accountDetailsVM = mAccountDetailsVM;
        boolean accountDetailsVMIsLoading = false;
        com.uni.julio.superplus.model.User user = mUser;
        ...
        if ((dirtyFlags & 0xbL) != 0) {
            ...
            com.uni.julio.superplus.binding.BindingAdapters.bindHiddenVisibility(this.accountDetailsContent, accountDetailsVMIsLoadingGet);
            com.uni.julio.superplus.binding.BindingAdapters.bindHiddenVisibility(this.progressBar, accountDetailsVMIsLoading);
        }
        if ((dirtyFlags & 0xaL) != 0) {
            // api target 1
        ...
        if ((dirtyFlags & 0xcL) != 0) {
            ...
            com.uni.julio.superplus.binding.BindingAdapters.setDate(this.mboundView4, userExpirationDate);
