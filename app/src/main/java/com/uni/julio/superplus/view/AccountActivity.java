...
import com.uni.julio.superplus.viewmodel.AccountDetailsViewModel;
import com.uni.julio.superplus.viewmodel.AccountDetailsViewModelContract;
...
public class AccountActivity extends BaseActivity implements AccountDetailsViewModelContract.View {
    ...
    Uri getFileUri(Context context, File file) {
        return FileProvider.getUriForFile(context,
                "com.uni.julio.superplus.fileprovider"
                , file);
    }
