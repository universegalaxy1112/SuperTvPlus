...
import com.uni.julio.superplus.listeners.LiveTVCategorySelectedListener;
...
public class LiveCategoryAdapter extends TVRecyclerViewAdapter<LiveCategoryAdapter.MyViewHolder> {
    ...
    protected void onDataBinding(MyViewHolder holder, int position) {
        ...
        holder.getViewDataBinding().setVariable(com.uni.julio.superplus.BR.liveCategory, category);
        ...
        holder.getViewDataBinding().setVariable(com.uni.julio.superplus.BR.liveCategoryAdapter, this);
